...
if __name__ == "__main__":
    part = Part(file_path=r"E:\Dev_s\分卷\提供给档案馆用（需分件）20241017\X097提供给档案馆用（仅扫描，未分件）",excel_path=r"E:\Dev_s\分卷\提供给档案馆用（需分件）20241017\X097提供给档案馆用（仅扫描，未分件）\2022年度卷内目录（提供给档案馆用）.xlsx")
    part.make_dir()
    part.img_part()
